...
public class PrintListViewController: UITableViewController {

    public let printerManager : BluetoothPrinterManager? =  BluetoothPrinterManager()

    public var sectionTitle: String? = "Printer"
    ...
    @IBAction func printTest(_ sender: Any) {
        ...
        vc.bluetoothPrinterManager = printerManager
        navigationController?.pushViewController(vc, animated: true)
    }
    
}

extension PrintListViewController: PrinterManagerDelegate {
